...
import { useFocusController, useId } from "@yzy-element/hooks";
  ...
  <div class="er-input" :class="{
    ...
    <template v-if="type !== 'textarea'">
      ...
      <div class="er-input__wrapper" ref="wrapperRef">
        ...
        <input class="er-input__inner" ref="inputRef" :id="useId().value"
    ...
    <!-- textarea -->
    <template v-else>
      <textarea class="er-textarea__wrapper" ref="textareaRef" :id="useId().value" :disabled="isDisabled"
