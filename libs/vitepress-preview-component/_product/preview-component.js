...
const S = /* @__PURE__ */ V(J, [["render", X]]), Y = {}, ee = {
  t: "1661231449868",
  class: "icon",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
function oe(o, t) {
  return a(), p("svg", ee, ne);
}
const U = /* @__PURE__ */ V(Y, [["render", oe]]), se = {}, ce = {
  viewBox: "0 0 544 560",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, ie = /* @__PURE__ */ i("path", {
...
function re(o, t) {
  return a(), p("svg", ce, le);
}
const E = /* @__PURE__ */ V(se, [["render", re]]), k = "vitepress-demo-preview", $ = (o, t, e, c) => {
  let l = t === "" ? `${o}` : `${o}-${t}`;
...
function _e(o, t) {
  return a(), p("svg", ae, pe);
}
const ve = /* @__PURE__ */ V(ue, [["render", _e]]), me = /* @__PURE__ */ Z({
...
const A = [], R = {
  open: () => {
    const o = document.createElement("div"), t = G(me, {
      content: "\u590D\u5236\u6210\u529F\uFF01",
      close: () => {
        document.body.removeChild(o), A.pop(), t.unmount();
      }
    }), e = t.mount(o);
    document.body.appendChild(o);
    const c = A.length, l = c === 0 ? 10 : (c + 1) * 10 + c * 42;
    e.setTopHeight(l), e.setVisible(!0), A.push(e);
  }
  ...
  setup(o) {
    const t = o, e = B(), { isCodeFold: c, setCodeFold: l } = O(), { copyContent: v, clickCopy: m } = z(), h = _(decodeURIComponent(t.code)), C = _(decodeURIComponent(t.showCode)), d = _(null), L = () => {
      m(h.value), R.open();
    }, g = T(() => {
      var r;
    ...
    return N(() => {
      ...
      return a(), p("div", {
        ...
        i("section", {
          ...
          t.title ? (a(), p("div", {
            key: 0,
            class: u([n(e).bem("description", "title")])
          }, b(r.title), 3)) : M("", !0),
          t.description ? (a(), p("div", {
            key: 1,
            class: u([n(e).bem("description", "content")]),
            innerHTML: r.description
          }, null, 10, he)) : M("", !0),
          t.description || !t.title && !t.description ? (a(), p("div", {
            key: 2,
            class: u([n(e).bem("description", "split-line")])
          }, null, 2)) : M("", !0),
          i("div", {
            class: u([n(e).bem("description", "handle-btn")])
          }, [
            n(c) ? (a(), y(S, {
              key: 1,
              onClick: f[1] || (f[1] = (P) => n(l)(!1))
            })) : (a(), y(U, {
              key: 0,
              onClick: f[0] || (f[0] = (P) => n(l)(!0))
            })),
            H(E, { onClick: L })
          ], 2)
        ], 2),
...
const ge = ["innerHTML"], Me = /* @__PURE__ */ Z({
  __name: "ElementPlus",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const t = o, e = B(), { isCodeFold: c, setCodeFold: l } = O(), { clickCopy: v } = z(), m = _(decodeURIComponent(t.code)), h = _(decodeURIComponent(t.showCode)), C = _(null), d = () => {
      v(m.value), R.open();
    }, L = T(() => {
      var s;
...
const fe = ["innerHTML"], we = /* @__PURE__ */ Z({
  __name: "NaiveUI",
  props: {
    code: {},
    showCode: {},
    ...
    return N(() => {
      ...
      return a(), p("div", {
        ...
        i("section", {
          ...
          t.title ? (a(), p("div", {
            key: 0,
            class: u([n(e).bem("component", "name")])
          }, b(s.title), 3)) : M("", !0),
          i("div", {
            class: u([n(e).bem("description", "btns")])
          }, [
            H(E, { onClick: d }),
            n(c) ? (a(), y(S, {
              key: 1,
